...
//         if(type === "open_ended") {
//             questions = await strict_output(
//                 "You are a helpful AI that is able to generate a pair of questions and answers, the length of the answer should not exceed 15 words, store all the pairs of answeres and questions in a JSON array",
//                 new Array(amount).fill(
